...
def vis_trail(scene_dir, kpts_foreground, kpts_background, save_path, low_pt=0, high_pt=sys.maxsize):
    """
...
if __name__ == '__main__':
    ...
    if trainer.with_mask or mask is not None:
        ...
        # visualize trails
        kpts_foreground = kpts_forground[:, ::1]  # can adjust kpts sampling rate here
        ...
        while i <= num_pts:
            ...
            vis_trail(args.data_dir, kpts_forground, kpts_background,
                      os.path.join(vis_dir, '{}_{:06d}_{}_{}_{}_trails.mp4'.format(seq_name, trainer.step, query_id, low_pt, i)),
                      low_pt=low_pt, high_pt=i)
            i += pt_range
