...
class GeometryBaseAug:
    ...
    def map_affine_transformation(self, sample, affine_transf, new_size=None):
        image = cv2.rectangle(np.array(sample['image']), (int(sample['bbox'][0]), int(sample['bbox'][1])), (int(sample['bbox'][0] + sample['bbox'][2]), int(sample['bbox'][1] + sample['bbox'][3])), (255, 0, 0), 2)
        ...
        image2 = cv2.rectangle(np.array(sample['image']), (int(sample['bbox'][0]), int(sample['bbox'][1])), (int(sample['bbox'][0] + sample['bbox'][2]), int(sample['bbox'][1] + sample['bbox'][3])), (255, 0, 0), 2)
